...
files<-list.files(path="~/RSaturday-proposal/proposal/interestedparties_files/figure-markdown_strict/",
                  pattern = "*.png")
file.copy(files,"~/RSaturday-proposal/proposal")
file.copy(files,"~/RSaturday-proposal/")
```
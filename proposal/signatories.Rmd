...
We already have more than `r floor(sum(promises == 'Presenting at a satRday') / 100) * 100` presenters and `r sum(promises == 'Helping improve the website')` webmasters -- what can go wrong?
